    ...
    <form action="https://formspree.io/f/xayzlwnp" method='POST' className="mt-10">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <div className="relative z-0 col-span-2">
          ...
          <label className="absolute top-3  -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-black duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-blue-600 peer-focus:dark:text-blue-500">Your message</label>
        </div>
      </div>
